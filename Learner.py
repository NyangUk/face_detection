...
class MS1MDataset(Dataset):
    ...
    def __init__(self,split):
        ...
        self.file_list = '/home/leo/Desktop/inha_challenge/inha_data/ID_List.txt'
        self.images = []
        self.labels = []
...
class face_learner(object):
    def __init__(self, conf, inference=False):
        ...
        if not inference:
            ...
            self.loader = torch.utils.data.DataLoader(train_dataset, batch_size=conf.batch_size, shuffle=True, pin_memory=conf.pin_memory, num_workers=conf.num_workers)
            self.class_num = 86876
